...
export type I18nKey =
  ...
  | 'usageStats.byModel.agent'
  | 'usageStats.byModel.model'
  | 'usageStats.byModel.sessions'
  | 'usageStats.byModel.title'
  | 'usageStats.byModel.tokens'
  | 'usageStats.comparison.modelsTitle'
  | 'usageStats.comparison.projectsTitle'
  | 'usageStats.comparison.title'
  | 'usageStats.composition.cacheCreation'
  | 'usageStats.composition.cacheRead'
  ...
  | 'usageStats.granularity.week'
  | 'usageStats.kpi.cacheRatio'
  | 'usageStats.kpi.messages'
  | 'usageStats.kpi.sessions'
  | 'usageStats.kpi.totalTokens'
  | 'usageStats.menuLabel'
  | 'usageStats.refresh'
  | 'usageStats.sessions.agent'
  | 'usageStats.sessions.loadMore'
  | 'usageStats.sessions.model'
  | 'usageStats.sessions.project'
  | 'usageStats.sessions.time'
  | 'usageStats.sessions.title'
  | 'usageStats.sessions.tokens'
  | 'usageStats.sessions.total'
  | 'usageStats.source.missing'
  | 'usageStats.source.skipped'
  | 'usageStats.summary.cacheCreation'
  | 'usageStats.summary.cacheRead'
  | 'usageStats.summary.input'
  | 'usageStats.summary.messages'
  | 'usageStats.summary.output'
  | 'usageStats.summary.sessions'
  | 'usageStats.summary.totalTokens'
  | 'usageStats.timeRange.30d'
